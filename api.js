  ...
  const preload = {
    ...
    async program(id) {
      await Promise.all([
        ...
        Assignments.fetchByProgram(id).catch(() => {}),
        Placements.fetchByProgram(id).catch(() => {}),
        CustomerAssignments.fetchByProgram(id).catch(() => {}),
        CustomerBuys.fetchByProgram(id).catch(() => {}),
        Submissions.fetchByProgram(id).catch(() => {}),
