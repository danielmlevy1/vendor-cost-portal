...
All four script/CSS tags in `index.html` share a single version string (`?v=127` currently). **Bump this number whenever any JS or CSS file changes** to avoid stale-browser-cache bugs.
